...
usage() {
	printf "Usage:\n"
	printf "  $0 pawr_node [daemon] [cli_options] [-l] [-v size]\n"
	printf "    daemon\n"
	printf "      start as daemon\n\n"
	printf "    cli_options\n"
	printf "      pawr_node cli options <see pawr_node --help>\n\n"
	printf "    -l\n"
