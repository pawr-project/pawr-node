...
std::string const default_live_peer_network = nano::get_env_or_default ("NANO_DEFAULT_PEER", "peering.pawr.net");
std::string const default_beta_peer_network = nano::get_env_or_default ("NANO_DEFAULT_PEER", "peering-beta.pawr.net");
std::string const default_test_peer_network = nano::get_env_or_default ("NANO_DEFAULT_PEER", "peering-test.pawr.net");
}
